...
fig.savefig(f"{img_fold}/year_dist.svg")
plt.show()

# 2D distributions
fig = fig_2Dhist(data)
fig.savefig(f"{img_fold}/year_dist_2D.svg")
plt.show()
...
fig.savefig(f"{img_fold}/M_year_dist.svg")
plt.show()

# 2D distributions
fig = fig_2Dhist(dta, kw)
fig.savefig(f"{img_fold}/M_year_dist_2D.svg")
plt.show()
...
fig = fig_histogram(dta)
fig.savefig(f"{img_fold}/F_year_dist.svg")
plt.show()

# 2D distributions
fig = fig_2Dhist(dta, kw)
fig.savefig(f"{img_fold}/F_year_dist_2D.svg")
plt.show()
